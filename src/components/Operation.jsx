...
const Operation = () => {
    return (
        ...
        lg:relative lg:pt-62 lg:mt-0 lg:mb-25">
            <div 
            ...
            lg:px-[6%]">
                ...
                className="w-28 
                md:w-45 
                lg:w-50 lg:absolute lg:top-29"/>
                <h2 
                className="font-sans font-regular text-2xl text-center text-black mb-20 
                md:text-4xl"><span className="font-sans font-bold text-2xl text-black mr-2 border-b-4 border-secondary pb-2 md:text-4xl">Operation</span> Mode</h2>
                <img 
                className="hidden 
                lg:block lg:absolute lg:left-[370px] lg:bottom-[330px]"
                src={decorOperation} 
                alt="Decor"/>
                <div 
                ...
                lg:gap-14">
                    ...
                    lg:gap-65 lg:justify-center">
                        <div className="md:order-2">
                            ...
                            <p 
                            className="font-sans font-regular text-xs text-muted leading-normal mb-5 
                            md:text-sm md:max-w-[300px]">Then, you can send us your inventory and the fun begins. We’ll choose a delivery day together so your fulfilment is not interrupted.</p>
                        </div>
                    ...
                    <div 
                    className="md:flex md:items-center 
                    lg:gap-65 lg:justify-center lg:ml-10">
                        <div>
                            <div className="flex items-center gap-4 mb-7 md:gap-7">
