...
const Hero = () => {
    return (
        <section className="mt-6 mb-20 relative lg:mt-25 lg:mb-25">
                ...
                <div className="max-w-[1440px] mx-auto px-[5%] lg:px-[6%]">
                    <div className="lg:flex">
                        <div className="lg:max-w-[575px] lg:pt-35">
                            ...
                            lg:gap-3 lg:mx-0">
                                <a className="font-sans font-bold text-xs text-white text-center bg-primary cursor-pointer
                                py-5 px-12
                                w-fit
                                rounded-xl
                            ...
                            <div className="mt-13 mb-13 lg:mb-29">
                                ...
                                className="hidden md:block md:max-w-[600px]"/>
                            </div>
                    </div>
                    <PricingForm/>
                </div>
