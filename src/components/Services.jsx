...
const Services = () => {
    return (
        <section className="bg-light-blue pt-19 pb-12 lg:pt-43 lg:pb-25">
            <div className="max-w-[1440px] mx-auto px-[5%] lg:px-[6%]">
                <div className="flex justify-between items-center relative">
                    ...
                    className="w-30 absolute -top-8 right-0 lg:w-50 lg:-top-20"/>

                </div>
                <div className="flex flex-col gap-12 lg:flex-row lg:gap-19 lg:justify-center">
                    <div>
                ...
                <div className="max-w-[440px] flex flex-row justify-between gap-7 mx-auto mt-20 lg:mt-25">
                    <a href="/" 
